...
set BuilderOptsCommon=-logger=machine %ArduinoHWDir% %ArduinoToolsDir% %OtherToolsDir% %ArduinoBuiltInLibs% %TeensyFQBN% %ArduinoIDEVersion% %BuildPath% -warnings=none %BuildCache% -verbose %TEENSYINO%
